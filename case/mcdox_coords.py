...
labelsL_dvorak = [
 ...
 (-90, [('Ctrl',    -3.0, +9.0)                                                     ]),
 (0,   [('Flip',    -0.6, +5.0)                                                     ]),
 (0,   [('Del',     -4.0, +6.0),                            ('Ins',    -3.5, -7.0)  ]),
 (0,   [('Alt',     -4.0, +6.0)                                                     ]),
 (0,   [('`',       -6.0, +4.5),    ('~',  -3.5, +8.5)                              ]),
 (0,   [('F4',      -7.0, +3.0),                            ('F6',     +1.0, -8.0)  ]),
 (-90, [('Home',    -7.0, +6.0),                            ('Vol+',   -2.0, -7.0)  ]),
 (-90, [('End',     -7.0, +6.0),                            ('Vol-',   -2.0, -7.0)  ]),
 (0,   [('5',       -7.0, +3.0),    ('%',  -7.0, +7.0),     ('F5',     +1.0, -8.0)  ]),
 (0,   [('Y',       -7.0, +4.0)                                                     ]),
 (0,   [('I',       -7.0, +4.0)                                                     ]),
 (0,   [('X',       -7.0, +4.0)                                                     ]),
 (0,   [('4',       -7.0, +3.0),    ('$',  -7.0, +7.0),     ('F4',     +1.0, -8.0)  ]),
 (0,   [('P',       -7.0, +4.0)                                                     ]),
 (0,   [('U',       -7.0, +4.0)                                                     ]),
 (0,   [('K',       -7.0, +4.0)                                                     ]),
 (0,   [                                                                            ]),
 (0,   [('3',       -7.0, +3.0),    ('#',  -7.0, +7.0),     ('F3',     +1.0, -8.0)  ]),
 (0,   [('.',       -7.0, +4.0),    ('>',  -7.0, +7.0)                              ]),
 (0,   [('E',       -7.0, +4.0)                                                     ]),
 (0,   [('J',       -7.0, +4.0)                                                     ]),
 (0,   [                                                                            ]),
 (0,   [('2',       -7.0, +3.0),    ('@',  -7.0, +7.0),     ('F2',     +1.0, -8.0)  ]),
 (0,   [(',',       -7.0, +4.0),    ('<',  -7.0, +7.0)                              ]),
 (0,   [('O',       -7.0, +4.0)                                                     ]),
 (0,   [('Q',       -7.0, +4.0)                                                     ]),
 (0,   [('App',     -7.0, +4.0)                                                     ]),
 (0,   [('1',       -7.0, +3.0),    ('!',  -6.0, +7.0),     ('F1',     +1.0, -8.0)  ]),
 (0,   [('\'',      -5.5, +2.0),    ('"',  -5.5, +5.0)                              ]),
 (0,   [('A',       -7.0, +4.0)                                                     ]),
 (0,   [(';',       -6.7, +3.9),    (':',  -6.0, +7.0)                              ]),
 (0,   [('PgDn',    -7.0, +4.0)                                                     ]),
