...
labelsL_dvorak = [
 ...
 (-90, [('Ctrl',    -7.0, +4.0)                                                     ]),
 (0,   [('Flip',    -7.0, +4.0)                                                     ]),
 (0,   [('Del',     -7.0, +4.0),                            ('Ins',    +2.0, -7.0)  ]),
 (0,   [('Alt',     -7.0, +4.0)                                                     ]),
 (0,   [('`',       -7.0, +4.0),    ('~',  -4.0, +9.0)                              ]),
 (0,   [('F4',      -7.0, +4.0),                            ('F6',     +2.0, -7.0)  ]),
 (-90, [('Home',    -7.0, +6.0),                            ('Vol+',   +2.0, -7.0)  ]),
 (-90, [('End',     -7.0, +6.0),                            ('Vol-',   +2.0, -7.0)  ]),
 (0,   [('5',       -7.0, +4.0),    ('%',  -7.0, +7.0),     ('F5',     +2.0, -7.0)  ]),
 (0,   [('Y',       -7.0, +4.0)                                                     ]),
 (0,   [('I',       -7.0, +4.0)                                                     ]),
 (0,   [('X',       -7.0, +4.0)                                                     ]),
 (0,   [('4',       -7.0, +4.0),    ('$',  -7.0, +7.0),     ('F4',     +2.0, -7.0)  ]),
 (0,   [('P',       -7.0, +4.0)                                                     ]),
 (0,   [('U',       -7.0, +4.0)                                                     ]),
 (0,   [('K',       -7.0, +4.0)                                                     ]),
 (0,   [                                                                            ]),
 (0,   [('3',       -7.0, +4.0),    ('#',  -7.0, +7.0),     ('F3',     +2.0, -7.0)  ]),
 (0,   [('.',       -7.0, +4.0),    ('>',  -7.0, +7.0)                              ]),
 (0,   [('E',       -7.0, +4.0)                                                     ]),
 (0,   [('J',       -7.0, +4.0)                                                     ]),
 (0,   [                                                                            ]),
 (0,   [('2',       -7.0, +4.0),    ('@',  -7.0, +7.0),     ('F2',     +2.0, -7.0)  ]),
 (0,   [(',',       -7.0, +4.0),    ('<',  -7.0, +7.0)                              ]),
 (0,   [('O',       -7.0, +4.0)                                                     ]),
 (0,   [('Q',       -7.0, +4.0)                                                     ]),
 (0,   [('App',     -7.0, +4.0)                                                     ]),
 (0,   [('1',       -7.0, +4.0),    ('!',  -7.0, +7.0),     ('F1',     +2.0, -7.0)  ]),
 (0,   [('\'',      -5.0, +2.0),    ('"',  -5.0, +5.0)                              ]),
 (0,   [('A',       -7.0, +4.0)                                                     ]),
 (0,   [(';',       -7.0, +4.0),    (':',  -7.0, +7.0)                              ]),
 (0,   [('PgDn',    -7.0, +4.0)                                                     ]),
...
labelsR_dvorak = [
 ...
 (0,   [('Mute',    -3.0, +2.0)                                                     ]),
 (0,   [('Super',   -3.0, +2.0),                                                    ]),
 (0,   [('F5',      -3.0, +2.0),                            ('F7',     +4.0, -4.0)  ]),
 (90,  [('[',       -3.0, +2.0),    ('{',  -3.0, +5.0),                             ]),
 (90,  [(']',       -3.0, +2.0),    ('{',  -3.0, +5.0),                             ]),
 (0,   [('6',       -3.0, +2.0),    ('^',  -3.0, +5.0),     ('F8',     +4.0, -4.0)  ]),
 (0,   [('F',       -3.0, +2.0)                                                     ]),
 (0,   [('D',       -3.0, +2.0)                                                     ]),
 (0,   [('B',       -3.0, +2.0)                                                     ]),
 (0,   [('7',       -3.0, +2.0),    ('&',  -3.0, +5.0),     ('F9',     +4.0, -4.0)  ]),
 (0,   [('G',       -3.0, +2.0)                                                     ]),
 (0,   [('H',       -3.0, +2.0),                            ('clkL',   +4.0, -4.0)  ]),
 (0,   [('M',       -3.0, +2.0),                            ('scrL',   +4.0, -4.0)  ]),
 (0,   [('Lft',     -3.0, +2.0),                            ('msL',    +4.0, -4.0)  ]),
 (0,   [('8',       -3.0, +2.0),    ('*',  -3.0, +5.0),     ('F10',    +4.0, -4.0)  ]),
 (0,   [('C',       -3.0, +2.0),                                                    ]),
 (0,   [('T',       -3.0, +2.0),                            ('clkM',   +4.0, -4.0)  ]),
 (0,   [('W',       -3.0, +2.0),                            ('srcM',   +4.0, -4.0)  ]),
 (0,   [('Up',      -3.0, +2.0),                            ('msU',    +4.0, -4.0)  ]),
 (0,   [('9',       -3.0, +2.0),    ('(',  -3.0, +5.0),     ('F11',    +4.0, -4.0)  ]),
 (0,   [('R',       -3.0, +2.0),                                                    ]),
 (0,   [('N',       -3.0, +2.0),                            ('clkR',   +4.0, -4.0)  ]),
 (0,   [('V',       -3.0, +2.0),                            ('scrD',   +4.0, -4.0)  ]),
 (0,   [('Dn',      -3.0, +2.0),                            ('msD',    +4.0, -4.0)  ]),
 (0,   [('0',       -3.0, +2.0),    (')',  -3.0, +5.0),     ('F12',    +4.0, -4.0)  ]),
 (0,   [('L',       -3.0, +2.0),                                                    ]),
 (0,   [('S',       -3.0, +2.0)                                                     ]),
 (0,   [('Z',       -3.0, +2.0),                            ('scrR',   +4.0, -4.0)  ]),
 (0,   [('Rgt',     -3.0, +2.0),                            ('msR',    +4.0, -4.0)  ]),
 (0,   [('/',       -3.0, +2.0),    ('?',  -3.0, +5.0)                              ]),
 (0,   [('=',       -3.0, +2.0),    ('+',  -3.0, +5.0)                              ]),
 (0,   [('-',       -3.0, +2.0),    ('_',  -3.0, +5.0)                              ]),
 (0,   [('Ctrl',    -3.0, +2.0)                                                     ]),
